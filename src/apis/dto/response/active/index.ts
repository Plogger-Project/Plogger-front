...
import GetActiveCommentListResponseDto from "./get-active-comment-list.response.dto"
import GetActiveReportListResponseDto from "./get-active-report-list.response.dto"

export type {
    GetMyRecruitReponseDto,
    GetActivePostResponseDto,
    GetActivePostListResponseDto,
    GetActiveCommentListResponseDto,
    GetActiveReportListResponseDto
}