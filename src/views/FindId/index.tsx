...
export default function FindId() {
    ...
    const sendAuthResponse = (responseBody: ResponseDto | null) => {
        ...
        const message =
            ...
            responseBody.code === 'NT' ? '중복되는 전화번호가 없습니다.' :
    ...
    const findIdResponse = (responseBody: ResponseDto | null) => {
        const message =
            !responseBody ? '서버에 문제가 있습니다.' :
    ...
    const FindIdResponseHandler = (response: FindIdResponseDto | ResponseDto | null) => {
        if (response === null) {
        ...
        setFind(true);
        const userId = (response as FindIdResponseDto).userId;
    ...
    const onTelNumberSendClickHandler = () => {
        ...
        const requestBody: SendAuthRequestDto = { telNumber };
        sendAuthRequest(requestBody).then(sendAuthResponse);
    };
    ...
    const onAuthInButtonClickHandler = async () => {
        ...
        try {
            const response = await findIdRequest(requestBody);
            ...
            <div className='find-id-main'>
                ...
                <div className='find-id-bottom'>
                    <div className='button-container-find'>
                        <div className='button-find-id' onClick={onAuthInButtonClickHandler}>아이디 확인</div>
